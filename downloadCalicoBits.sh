...
curl -o calicoctl -L https://github.com/projectcalico/calicoctl/releases/download/v1.3.0/calicoctl
...
tar cvfz calico-cni-1.9.tar.gz calico calico-ipam portmap calicoctl
